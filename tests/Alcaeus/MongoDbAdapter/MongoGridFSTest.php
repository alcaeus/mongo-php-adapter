...
class MongoGridFSTest extends TestCase
{
	...
	{
		$collection = $this->getCollection('foofs');
    ...
    public function testStoringData()
    {
        ...
        $this->assertAttributeInstanceOf('MongoDB\BSON\ObjectID', 'file_id', $firstChunk);
        $this->assertSame((string) $id, (string) $firstChunk->file_id);
        ...
        $this->assertAttributeInstanceOf('MongoDB\BSON\ObjectID', 'file_id', $secondChunck);
        $this->assertSame((string) $id, (string) $secondChunck->file_id);
     ...
     * @return \MongoGridFS
     */
    protected function getCollection($name = 'testfs')
    {
